...
class ReportPanel {
    static panel;
    static async show(extensionUri, scanner) {
        ...
        if (ReportPanel.panel) {
            ...
            ReportPanel.panel = vscode.window.createWebviewPanel("aiFootprintReport", "AI Footprint Report", vscode.ViewColumn.Beside, { enableScripts: false });
